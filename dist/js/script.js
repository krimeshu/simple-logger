...
(function (window) {
    ...
    function Leaf(ox, dx, speed, size) {
        ...
        console.log('New Leaf {from: (%d, %d), to: (%d, %d), speed: %d, size: %d}',
    ...
    bgImg.src = isOnline ? "#link('C:/Users/krimeshu/AppData/Local/Temp/FC_BuildDir/simple-logger/images/bg.jpg')" : 'images/bg.jpg';
    ...
    leavesImg.src = isOnline ? "#link('C:/Users/krimeshu/AppData/Local/Temp/FC_BuildDir/simple-logger/images/leaves.png')" : 'images/leaves.png';
